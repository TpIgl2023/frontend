...
export default function NavArticles() {
  return (
    ...
    <nav className={`px-6 md:px-10 lg:px-16 2xl:px-24 ${styles.paddingY}  flex items-center justify-between bg-main`}>
      <Link to="/Home" className="font-jost font-bold text-2xl xs:text-3xl sm:text-4xl lg:text-5xl text-white  ">PDFinder</Link>
      <div className="hidden lg:block">
        <div className="flex gap-10 items-center">
          ...
          <p className="font-inter text-white text-xl xl:text-2xl cursor-pointer">Filtrer</p>
        </div>
      </div>

  <div className="flex gap-[20px] sm:gap-[30px] items-center">
    <div className="lg:hidden">
      <img src={SearchIcon} alt="" className="cursor-pointer w-[35px] text-white"/>
    </div>
    <DropDOwnHome/>
  </div>
