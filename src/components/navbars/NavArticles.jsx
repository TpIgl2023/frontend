...
export default function NavArticles() {
  return (
    <nav className={`${styles.paddingX} ${styles.paddingY}  flex items-center justify-between bg-[#1B76FF]`}>
      <Link to="/Home" className="font-jost font-bold text-5xl text-white  ">PDFinder</Link>
      <div className="flex gap-10 items-center">
        <div className="flex py-2 px-3 bg-white rounded-full w-[500px] shadow-[0px_5px_10px_rgb(140,140,140)]">
