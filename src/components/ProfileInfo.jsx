...
export default function ProfileInfo() {
  ...
  return (
    ...
    <div className="bg-gradient-to-r from-[#F5F6F8] via-[#F5F6F8] to-[#EFE8F0] pb-[70px] ,x-auto">
      <h1 className="text-center font-inter font-semibold text-6xl py-[100px]">Profile</h1>
      ...
      <div className="mt-[70px] bg-white max-w-[900px] mx-auto rounded-2xl ">
        <div className="flex py-16 items-center w-full">
        <div className="w-[150px]  ml-[10%] mr-[15%]">
              <label className="font-inter font-semibold text-2xl ">old :</label>
        </div>          
          <div className="border-[#A9AABC] border-2">
            <input type="password" className="w-[300px] outline-none py-1 text-center font-inter text-xl text-[#A9AABC]"/>
          </div>
        </div>
        <div className="flex items-center w-full">
        <div className="w-[150px]  ml-[10%] mr-[15%]">
              <label className="font-inter font-semibold text-2xl ">newr :</label>
          </div>          
          <div className="border-[#A9AABC] border-2">
            <input type="password" className="w-[300px] outline-none py-1 text-center font-inter text-xl text-[#A9AABC]"/>
          </div>
