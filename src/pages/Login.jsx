      ...
      <div className="bg-gradient-to-r from-[#F5F6F8] via-[#F5F6F8]  to-[#EFE8F0]">
        <div className=" max-w-[700px] mx-auto py-[100px] ">
            <div className="h-full w-full bg-white rounded-[60px] ">
                <form onSubmit={handleSubmit} className="mx-auto px-16 pb-[100px] pt-[50px]">
                    <h2 className="text-center py-12 text-[#1B76FF] font-inter font-semibold text-6xl">Welcome back !</h2>

                    <div className="flex flex-col pb-[100px] pt-[50px]     ">
                        <label className="font-inter text-3xl py-5 ">Email or Username</label>
                        <input name="username" type="text" className="bg-[#F4F4F4]  p-4 text-2xl font-inter rounded-xl focus:outline-[#1B76FF]" />
                    </div>
                    <button className="w-full text-white bg-[#1B76FF] text-3xl text-center py-4 rounded-xl">Log in</button>
