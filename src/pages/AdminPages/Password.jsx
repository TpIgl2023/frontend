...
export default function Password() {
  ...
  return (
    <form action="" >
        ...
        <h1 className="text-center font-inter font-semibold text-3xl sm:text-4xl md:text-5xl xl:text-6xl py-[50px] sm:py-[75px] md:py-[100px]">Change your Password</h1>
      ...
      <div className="mt-[70px] flex  justify-center mx-auto">
          <button type="submit" className="sm:w-[300px] lg:w-[500px] text-2xl lg:text-3xl font-inter font-semibold text-white bg-main py-5 px-10 rounded-xl" >Edit Password</button>
      </div>
    </form>
