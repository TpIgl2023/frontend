...
export default function Article() {
  ...
  return (
    <div>
      ...
      {/*
      Web version*/}
      <div className='border-4 border-solid border-black w-10/12 h- mx-auto my-6 hidden sm:block'>
          <div className='flex w-full text-4xl'>
            ...
            <div id='motscle' className={`p-2 ${currsentSection == 'motscle' ?class2 : class3 } ${class1} `} onClick={() => setCurrentSection('motscle')}><h1>Mots cl̩s</h1></div>
