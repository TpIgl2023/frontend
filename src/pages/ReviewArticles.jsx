  ...
  return (
    <div>
      <NavArticles/>
       {
        Articles.length > 0 &&
      <ReviewArticlePopUp isOpen={isPopupOpen} handleClose={() => setPopupOpen(false)} article={ViewedArticle} handleSubmit={handleSubmitArticle} />
      }
      ...
      <div className="min-h-[500px] justify-center w-full">
        ...
        {Articles.map((Article) => (
          <ReviewPopup  Article={Article}  UserType={UserType} togglePopUp={() => setPopupOpen(true)} changeViewedArticle={changeViewedArticle}/>
        ))}
